...
// Removed @Service annotation to prevent bean conflict - this is now used as a dependency
public class JpaOAuth2AuthorizationService implements OAuth2AuthorizationService {
    ...
    private OAuth2Authorization toObject(OAuth2AuthorizationEntity entity) {
        ...
        if (entity.getAccessTokenValue() != null) {
            OAuth2AccessToken.TokenType tokenType = "BEARER".equals(entity.getAccessTokenType()) ?
